...
public:
    ...
    ImRect      MenuBarRect(float offset = 0.0f) const      { float y1 = Pos.y + TitleBarHeight; return ImRect(Pos.x + offset, y1, Pos.x + offset + SizeFull.x, y1 + MenuBarHeight + GImGui->Style.FramePadding.y); }
